            ...
            >
              ...
              >
                ...
                <p className="service-one__item__text">
                  ...
                  translation services, thanks to our impressive global network
                  of translators, editors, and proofreaders who work with all
                  major language pairs and combinations.
                </p>
                <div className="service-one__item__image">
                  <img
            ...
            >
              ...
              >
                ...
                <p className="service-one__item__text">
                  ...
                  have both portable and fixed equipment options available,
                  which can be tailored to any event or setting.
                </p>
                <div className="service-one__item__image">
                  <img
          ...
          <div className="row gutter-y-30 mt-3">
            ...
            >
              ...
              >
                <div className="service-one__item__top">
                  <h3 className="service-one__item__title">
                    <a href="#">Website Localization</a>
                  </h3>
                  <span className="service-one__item__count"></span>
                </div>
                <p className="service-one__item__text">
                  Our translation agency will localize your website to ensure
                  you speak the same language as your customers. Our linguistic
            ...
            >
              ...
              >
                <div className="service-one__item__top">
                  <h3 className="service-one__item__title">
                    <a href="#">Multilingual Videos</a>
                  </h3>
                  <span className="service-one__item__count"></span>
                </div>
                <p className="service-one__item__text">
                  Our subtitling services make your videos accessible to
                  speakers of other languages. We’ll transcribe the audio,
                  translate it into the target language, and then insert it into
                  the video.
                </p>
                <div className="service-one__item__image">
                  <img
            ...
            >
              ...
              >
                ...
                <p className="service-one__item__text">
                  Our voiceover artists provide high-quality sound recordings
